...
void main() async {
  ...
  for (int i = 1; i <= tirmidhiBooks.length; i++) {
    print("Book $i");
    Map<String, String> headers = {
      'X-API-KEY': 'SqD712P3E82xnwOAEOkGd5JZH8s9wRR24TqNFzjk',
    };
    String? url =
        'https://api.sunnah.com/v1/collections/tirmidhi/books/$i/hadiths?limit=500';
    while (url != null) {
      ...
      if (data["next"] != null) {
        url =
            'https://api.sunnah.com/v1/collections/tirmidhi/books/$i/hadiths?limit=500&page=${data["next"]}';
      } else {
        url = null;
      }
    }
    ...
    file.writeAsStringSync(
        "Map<String, List> tirmidhiHadiths = ${json.encode(hadiths)};");
  }
}
